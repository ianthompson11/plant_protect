...
actividades_path = os.path.join(os.getcwd(), 'actividades')
...
class VentanaSecundaria(tk.Frame):
    ...
    def seleccionar_imagen(self, parent):
        ...
        if (pc == 1):
            ...
            u="/User/Code/Github/TFODCourse/Pruebas"
        ...
        if ruta_imagen:
            ...
            if (pc == 1) :
                ...
                nueva_ruta =  r"C:\Users\ianda\Code\Github\TFODCourse\actividades\Fotos\foto" + extension  # Ruta de destino con el nombre "foto"
...
class VentanaTerciariaAlternativa(tk.Frame):
    ...
    def prepara_imagenes(self):
        ...
        current_folder = os.path.join(os.getcwd(), 'actividades', 'Fotos')
...
class Ventana_cuidado_plantas(tk.Frame):
    def __init__(self, parent):
        ...
        image_path = os.path.join(os.getcwd(), 'actividades', 'detecciones', 'detections.jpg')
        ...
        ruta_guardado = os.path.join(os.getcwd(), 'actividades', 'graficas')
